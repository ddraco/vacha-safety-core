...
def load_data():
    ...
    # Сглобяваме обект за времето за правилно 7-дневно сортиране
...
try:
    ...
    # 1. Линия на безопасност (40см) - разпъната по целия 7-дневен период
    fig.add_shape(
        type="line",
    ...
    # Настройки на мащабите
    fig.update_yaxes(range=[0, 150], secondary_y=False) 
    fig.update_yaxes(range=[0, 350], secondary_y=True)
    ...
    st.info("Провери дали CSV файловете са в папка 'data/' и дали имената на колоните са правилни.")